...
function t1() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Nikolay')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t2() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=25&num2=37')
            .then(data => {
                resolve(data.text());
            })
    });
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=25&num2=37')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=25&num2=37')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t4() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1983')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t5() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Nikolay',
        })
            .then(response => {
                resolve(response.text());
            });
...
function t6() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=21&num2=63',
        })
            .then(response => {
                resolve(response.text());
            });
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=21&num2=63',
        })
            .then(response => {
                resolve(response.text());
            });
...
function t7() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=21&num2=63',
        })
            .then(response => {
                resolve(response.text());
            });
...
function t8() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1983',
        })
            .then(response => {
                resolve(response.text());
            });
